...
const SignUpPage = () => {
	...
	return (
		<div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
			...
			>
				<h2 className='mt-6 text-center text-3xl font-extrabold text-primary-400'>Create your account</h2>
			</motion.div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									className=' block w-full px-3 py-2 pl-10 bg-gray-700 border
									 border-gray-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm'
									placeholder='••••••••'
								/>
							</div>
						</div>
						...
						<button
							...
							rounded-md shadow-sm text-sm font-medium text-white bg-primary-600
							 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2
							  focus:ring-primary-500 transition duration-150 ease-in-out disabled:opacity-50'
							disabled={loading}
						>
							{loading ? (
								<>
